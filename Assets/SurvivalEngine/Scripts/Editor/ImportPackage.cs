...
namespace SurvivalEngine.EditorTool
{
    ...
    public class ImportPackage
    {
        ...
        private static void AddSymbol(string symbol)
        {
            ...
            NamedBuildTarget namedBuildTarget = NamedBuildTarget.FromBuildTargetGroup(build_group);
            string defines_string = PlayerSettings.GetScriptingDefineSymbols(namedBuildTarget);
            ...
            PlayerSettings.SetScriptingDefineSymbols(namedBuildTarget, string.Join(";", all_defines.ToArray()));
